  ...
  return (
    <div className="flex h-[100dvh] w-full justify-center overflow-hidden bg-[#FAFBFD]">
      ...
      <MobilePageHeader title="My Branches" onBack={onBack} />
        ...
        <main className="scrollbar-hide absolute inset-x-0 bottom-[64px] top-[96px] w-full overflow-x-hidden overflow-y-auto bg-[#FAFBFD] px-6 pb-[88px] pt-4 lg:px-6 lg:pb-[60px] lg:pt-4">
          <div className="mx-auto flex w-full max-w-[354px] flex-col gap-4 lg:max-w-full lg:gap-6">
            <Banner className="mx-auto h-[89px] max-w-[354px] rounded-[10px] border border-[#E2E2E2] lg:h-[238px] lg:max-w-[952px] lg:border-0 lg:!rounded-[10px]" />

            <button
              type="button"
              onClick={() => setShowNewBranch(true)}
              className="flex h-[50px] w-full shrink-0 items-center justify-center rounded-[25px] bg-[#4A90E5] px-8 text-[17px] font-bold text-white shadow-sm transition-opacity hover:opacity-95 active:opacity-90 lg:mx-auto lg:h-[50px] lg:max-w-[636px] lg:px-[26px] lg:py-4"
            >
              <span className="flex h-[18px] w-[322px] items-center justify-center gap-2">
                <PlusCircle className="h-[18px] w-[18px] shrink-0 text-white" strokeWidth={2} aria-hidden />
                <span>Add Branch</span>
              </span>
            </button>

            <div className="flex flex-col gap-4 lg:mx-auto lg:w-full lg:max-w-[968px]">
              {branches.length > 0 ? (
                branches.map((branch) => (
                  <button
                    key={branch.id}
                  ...
                  >
                    <div className="flex min-w-0 flex-1 items-center gap-4">
                      ...
                      <div className="min-w-0 flex-1 border-l border-[#E2E2E2] pl-4">
                        <p className="text-[14px] font-bold leading-tight text-[#3D495E]">
