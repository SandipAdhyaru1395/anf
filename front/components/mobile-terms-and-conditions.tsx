...
export function MobileTermsAndConditions({ onNavigate }: MobileTermsAndConditionsProps) {
  ...
  return (
    <div className="flex h-[100dvh] w-full justify-center overflow-hidden bg-[#F6F4FA]">
      <div
        className="terms-desktop-frame relative mx-auto flex h-[100dvh] w-full max-w-[402px] flex-col bg-[#FAFBFD]"
      ...
      >
        ...
        <main className="min-h-0 w-full flex-1 bg-[#FAFBFD] px-4 pb-6 pt-3">
          <div className="terms-card mx-auto w-full max-w-[370px] rounded-[14px] border border-[#DFE7F4] bg-[linear-gradient(180deg,#FFFFFF_0%,#F8FBFF_100%)] p-4 shadow-[0_8px_20px_rgba(61,73,94,0.08)]">
            {loading ? (
