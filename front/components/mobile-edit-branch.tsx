...
export function MobileEditBranch({ branchDetails, onNavigate, onBack, onBranchUpdated }: MobileEditBranchProps) {
  ...
  return (
    ...
    >
      <div className="fixed top-0 left-1/2 z-[60] w-full max-w-[402px] -translate-x-1/2 lg:max-w-[1000px]">
        <MobilePageHeader title="Edit Branch" onBack={onBack} />
      </div>

      <main className="scrollbar-hide min-h-0 flex-1 overflow-x-hidden overflow-y-auto bg-[#FAFBFD] px-6 pb-[220px] pt-[112px] lg:px-4 lg:pb-[220px]">
        <div className="mx-auto flex w-full max-w-[354px] flex-col gap-6 lg:max-w-[968px]">
          ...
          <form id="edit-branch-form" onSubmit={handleSubmit(onSubmit)} noValidate className="flex w-full flex-col gap-4 lg:mx-auto lg:max-w-[700px]">
      ...
      <div className="fixed bottom-[64px] left-1/2 z-40 w-full max-w-[402px] -translate-x-1/2 bg-[#FAFBFD] px-6 pb-3 pt-2 lg:max-w-[1000px] lg:px-4">
        <div className="mx-auto w-full max-w-[354px] lg:max-w-[700px]">
          <button form="edit-branch-form" type="submit" disabled={isSaving} className={saveButtonClass}>
        ...
        <div className="flex min-h-0 w-full flex-1 items-center justify-center">
          <div className="flex h-[40px] w-[316px] max-w-full items-center justify-between">
            <button
              ...
              className="flex h-full min-w-0 cursor-pointer flex-col items-center justify-center gap-1 opacity-60 text-[#BDC7DE]"
            >
            ...
            <button
              ...
              className="flex h-full min-w-0 cursor-pointer flex-col items-center justify-center gap-1 text-[#4A90E5]"
              aria-current="page"
            >
